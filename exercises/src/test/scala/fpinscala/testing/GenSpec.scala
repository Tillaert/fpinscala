...
class GenSpec extends FlatSpec with Matchers {
  ...
  "Listing 8.1 sum reversed" should "be equal to the regular sum" in {
  ...
  "Listing 8.1 sum of same values" should "be equal to the length of the list times that value" in {
